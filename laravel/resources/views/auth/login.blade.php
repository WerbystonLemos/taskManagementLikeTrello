<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="w-full">
        ...
        <div class="flex flex-col items-center justify-end mt-4">
            ...
            <button class="w-full mb-4 bg-[#0052CC] px-4 py-2 border border-transparent rounded-sm font-semibold text-xs text-white text-center uppercase tracking-widest focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150 ">
                Continuar
            </button>
